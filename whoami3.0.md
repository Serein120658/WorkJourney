...
![image.png](https://api.apifox.com/api/v1/projects/3990113/resources/450645/image-preview)
...
:::highlight orange 📌
1.format 支持 ，int、float、decimal、boolean、string、date、timestamp（如有其他类型可联系新增）、
值为repcomma, 针对forminsert规则传入字符串参数数值 将逗号替换____，否则会报字段和字段值数目不一致
:::
