...
通过观察发现，在执行删除的时候，根据架构的设计是将对应的表中的isdel字段 更新为1
...
![image-20250728113537312](06.crud、复杂规则myrule和DButil类.assets/image-20250728113537312.png)
...
- 需要注意的是这个类需要实现Rule接口(文档里面要求)：如下
  ...
  >
  > ![image-20250728140339890](06.crud、复杂规则myrule和DButil类.assets/image-20250728140339890.png)
  >
  > 对于后端，该如何解析从而得到要的参数呢？
  >
...
![image-20250728113925295](06.crud、复杂规则myrule和DButil类.assets/image-20250728113925295.png)
