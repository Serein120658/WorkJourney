...
![image-20250915161748626](10.适配h5以及数据插件开发.assets/image-20250915161748626.png)
...
![image-20250915162425744](10.适配h5以及数据插件开发.assets/image-20250915162425744.png)
...
2. **从地址栏传递过来判断是那个端的pointType 使用三目运算符去设置流程图的方向的时候未生效  rankdir**  
   ...
   ![image-20250915161329743](10.适配h5以及数据插件开发.assets/image-20250915161329743.png)
