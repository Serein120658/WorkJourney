...
![image-20250729104639829](ZY.疑问与解惑.assets/image-20250729104639829.png)
...
![image-20250729101053310](ZY.疑问与解惑.assets/image-20250729101053310.png)

在system.js 源码文件中  可以看到msgwhere传递的对象会合并为一个对象到后端进行接收：

![image-20250729183352807](ZY.疑问与解惑.assets/image-20250729183352807.png)
...
3. 在使用layuitable的时候也有一个参数   lay-perm
   ...
   ![image-20250729113342659](ZY.疑问与解惑.assets/image-20250729113342659.png)

## 4、cp参数

场景：在练习myrule消息类型的时候，实现了Rule接口，编写方法时需要的参数 如图：

![image-20250729113824894](ZY.疑问与解惑.assets/image-20250729113824894.png)

p参数对应的是msg_where的

那cp对应的是啥？    did  指明数据库类型  

![image-20250729114029653](ZY.疑问与解惑.assets/image-20250729114029653.png)
